...
unsigned int getSTATUS(); //Manipulate Current Program Status Register (CPSR).
unsigned int getCAUSE(); //Manipulate Exception/Interrupt Cause register (CP15.R15).
unsigned int getTIMER();  //interval timer
unsigned int getTODHI();  //Returns the upper/lower part of Time of Day 64-bit register.
unsigned int getTODLO();
unsigned int getCONTROL();  //Manipulate System Control Register (CP15.SCB).
